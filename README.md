...
IGO2 est une solution Web gratuite en géomatique basée sur Angular 2, OpenLayers 3 et Bootstrap. Consultez le site Web d'IGO pour en savoir davantage: [http://igouverte.org/](http://igouverte.org/).
...
IGO2 (for Open GIS Infrastructure - version 2) is a free open source Web Geospatial solution developed in Quebec, Canada based on Angular2, OpenLayers 3 and Bootstrap. See this Web site for more information: [http://igouverte.org/english/](http://igouverte.org/english/).
IGO2 is having multiple features, such as Web GIS viewer for adapted to Desktop and Mobile and many more at [http://igo2.readthedocs.io/fr/latest/english.html](http://igo2.readthedocs.io/fr/latest/english.html).
...
- [Tests](#tests-en)
- [Follow-up in overv.io](https://overv.io/infra-geo-ouverte/igo2/)
- [Docker](#docker-en)
