...
import { ClientSchemaElementPoint, AnyClientSchemaElement } from './client-schema-element.interfaces';
...
export class ClientSchemaElementPointEditorService extends Editor {
  ...
  constructor(
    ...
    super({
      id: 'fadq.client-schema-element-point-editor',
      title: 'Points du schéma',
      tableTemplate: clientSchemaElementTableService.buildSurfaceTable(),
      entityStore: new FeatureStore<ClientSchemaElementPoint>(),
